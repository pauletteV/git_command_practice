...
function runAnimation() {
	...
	tl1.to(copy1, .5, {top: 60, delay: 1, ease: Power1.easeOut}); 

	/*tl1.call(frameChange1, [], this, 'bottomMove'); */
	tl1.set(copy2, {display: "block"},'bottomMove');
	tl1.from(copy2, .5, {top: 125, ease: Power1.easeOut}, 'bottomMove');
	
	/*tl1.call(frameChange2, [], this, 'ctaScale');*/
	tl1.to(cta, .75, {scale:1}, 'ctaScale');
	tl1.to(cta, .75, {scale: .8}); 
